...
import  { WhatShopexOffers}  from "@/components/what-shopex-offer";
import { DiscountSection } from "@/components/discount-section";
import { TrendingProducts } from "@/components/ui/trendingProduct"
import { TopCategories } from "@/components/top-categories";
import { Button } from "@/components/ui/button"
import { SectionHeader } from "@/components/ui/section-header";
import NewsletterSection from "@/components/newsletter-section";
import { BrandLogos } from "@/components/ui/brand-logo";
    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-gray-100">
        <div className="container md:w-[1177px] mx-auto flex justify-center px-6 ">
          ...
          <div className="absolute inset-0 w-[100%] rounded-full flex justify-center items-center pr-12 bg-[#FFF6FB]" />
            <div className="relative">
              <img
                src="/bsofa.png"
                alt="Featured Chair"
